...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Sistema de Armas do CBMERJ</title>
...
<body>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">Cap BM Coimbra</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="login.html"><i class="dw dw-logout"></i> Sair</a>
					</div>
				</div>
			</div>
	...
	<div class="right-sidebar">
		...
		<div class="right-sidebar-body customscroll">
			<div class="right-sidebar-body-content">
				<h4 class="weight-600 font-18 pb-10">Background Cabeçalho</h4>
				...
				<h4 class="weight-600 font-18 pb-10">Background Barra Lateral</h4>
				<div class="sidebar-btn-group pb-30 mb-10">
				...
				<h4 class="weight-600 font-18 pb-10">Ícone da Lista de Menu</h4>
				...
				<div class="reset-options pt-30 text-center">
					<button class="btn btn-danger" id="reset-settings">Redefinir Configurações</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
				<img src="img/brasao-dark.png" alt="" class="dark-logo img-logo-menu">
				<img src="img/brasao-light.png" alt="" class="light-logo img-logo-menu">
			</a>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Bem-vindo <div class="weight-600 font-30 text-blue">Cap BM Coimbra!</div>
						</h4>
						<p class="font-18 max-width-600 text-justify">O Sistema de Armas foi criado para o Corpo de Bombeiros Militar do Estado do Rio de Janeiro gerenciar e controlar os armamentos instutucionais e dos seus integrantes. O SisArm também vai agilizar o processo de aquisição, transferência e cadastramento dos militares.</p>
					</div>
				</div>
			</div>
			<div class="row">
